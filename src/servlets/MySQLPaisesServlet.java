...
/**
 * Servlet implementation class MySQLPaisesServlet
 */
@WebServlet("/mySQLPaises")
@MultipartConfig(maxFileSize= 16177215)
public class MySQLPaisesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MySQLPaisesServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(filePart!=null){
			...
			while(scan.hasNext()){
				sql=scan.next();
				respuesta = target().path("paises/carga")
						.request()
