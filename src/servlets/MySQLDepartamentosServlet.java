...
/**
 * Servlet implementation class MySQLDepartamentosServlet
 */
@WebServlet("/mySQLDepartamentos")
@MultipartConfig(maxFileSize= 16177215)
public class MySQLDepartamentosServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MySQLDepartamentosServlet() {
        super();
