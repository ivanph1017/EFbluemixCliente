...
/**
 * Servlet implementation class MySQLProvinciasServlet
 */
@WebServlet("/mySQLProvincias")
@MultipartConfig(maxFileSize= 16177215)
public class MySQLProvinciasServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MySQLProvinciasServlet() {
        super();
